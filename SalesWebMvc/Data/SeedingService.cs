...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {   //testar se existe algum registro nas tabelas de todas as entidades
            if(_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any())
            {
                return; // banco de dados já foi seeded
            }
            ...
            //criar vendedores
            Seller s1 = new Seller(1, "Joao Barros", "joaobarros@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Silva", "maria.silva@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Guerra", "alexguerra@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Marta Reis", "martareis@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Trump", "donald@gmail.com", new DateTime(2000, 6, 14), 4000.0, d3);
            Seller s6 = new Seller(6, "Miguel Martins", "miguelmartins@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
            ...
            _context.Department.AddRange(d1, d2, d3, d4); // AddRange é um metodo do EntityFrameworkCore que permite adic ionar vários objetos de uma só vez
